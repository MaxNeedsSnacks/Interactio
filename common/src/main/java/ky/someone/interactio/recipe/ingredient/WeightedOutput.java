...
public class WeightedOutput<E> extends LinkedHashSet<WeightedOutput.WeightedEntry<E>> {
    ...
    public static <E> WeightedOutput<E> deserialize(JsonObject json, EntrySerializer<E> serializer) {
        ...
        StreamSupport.stream(arr.spliterator(), false)
                ...
                .forEach(entry -> {
                    E result = serializer.fromJson(entry.getAsJsonObject("result"));
    ...
    public static <E> WeightedOutput<E> fromNetwork(FriendlyByteBuf buffer, EntrySerializer<E> serializer) {
        ...
        for (int i = 0; i < size; i++) {
            E result = serializer.fromNetwork(buffer);
    ...
    public void toNetwork(FriendlyByteBuf buffer, EntrySerializer<E> serializer) {
        ...
        forEach(entry -> {
            serializer.toNetwork(buffer, entry.getResult());
